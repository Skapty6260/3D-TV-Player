...
export default function LoadingSkeleton() {
	return (
		<div className='bg-black h-[100vh] w-full flex flex-col justify-center content-center space-y-6 items-center'>
			<svg
				height='120'
				viewBox='0 0 455 455'
				fill=''
			...
			>
				...
				<g fill='url(#ttb)'>
					<path
						d='M382.5,160c-17.921,0-32.5,14.58-32.5,32.5s14.579,32.5,32.5,32.5s32.5-14.58,32.5-32.5S400.421,160,382.5,160z M382.5,210
		c-9.649,0-17.5-7.851-17.5-17.5s7.851-17.5,17.5-17.5s17.5,7.851,17.5,17.5S392.149,210,382.5,210z'
					/>
					<path
						d='M382.5,240c-17.921,0-32.5,14.58-32.5,32.5s14.579,32.5,32.5,32.5s32.5-14.58,32.5-32.5S400.421,240,382.5,240z M382.5,290
		c-9.649,0-17.5-7.851-17.5-17.5s7.851-17.5,17.5-17.5s17.5,7.851,17.5,17.5S392.149,290,382.5,290z'
					...
					<path
						d='M427.5,120H209.159l51.71-95.148c6.029-0.887,10.676-6.08,10.676-12.352c0-6.893-5.607-12.5-12.5-12.5
		...
		c0.008,0,0.016,0.001,0.024,0.001c0.007,0,0.015-0.001,0.022-0.001H427.5c6.893,0,12.5,5.607,12.5,12.5V427.5z'
					/>
					<path
						d='M295.288,186.301C273.339,169.832,231.175,160,182.5,160s-90.839,9.832-112.789,26.301
		...
		c-0.494,4.113,2.439,7.847,6.553,8.341c4.104,0.486,7.846-2.44,8.34-6.553C328.762,266.469,322.452,206.681,295.288,186.301z'
			...
			<div
				className={`text-2xl font-bold text-white animate-pulse tracking-[0.3em] ${styles.loadingText}`}
			>
				Relax some time...
			</div>
		</div>
