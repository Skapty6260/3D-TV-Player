...
const createVideo = (
	...
	vid.volume = 0.1
	vid.muted = false
	vid.src = selector.CurrentVideo.video
...
export default function VintageTV(props: any) {
	...
	const [video, setVideo] = useState<any>(
		useMemo(
			() => createVideo(selector, props.isEnabled, vid),
			[selector.CurrentVideo.video]
		)
	)

	useEffect(() => {
		setVideo(createVideo(selector, props.isEnabled, vid, video))
	}, [selector.CurrentVideo.video])
